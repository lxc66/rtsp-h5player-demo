...
H5sPlayerWS.prototype.U = function (websoketUri) {
    ...
    try {
        "http:" == this.k.protocol && (h5SWebSocketClients = "undefined" != typeof MozWebSocket ? new MozWebSocket("ws://" + this.k.host + websoketUri) : new WebSocket("ws://" + this.k.host + websoketUri)), 
...
H5sPlayerWS.prototype.j = function (t) {
    ...
    console.log(t.data)
    if (!0 !== this.p)
    return !1 === this.H ? (this.C = String.fromCharCode.apply(null, new Uint8Array(t.data)), this.q(this), void(this.H = !0)) : (this.buffer.push(t.data), void this.K())
}; 
H5sPlayerWS.prototype.q = function (t) {
    try {
        window.MediaSource = window.MediaSource || window.WebKitMediaSource, 
        window.MediaSource || console.log("MediaSource API is not available");
        var mediaType = 'video/mp4; codecs="avc1.42E01E, mp4a.40.2"';
...
H5sPlayerWS.prototype.F = function () {
    ...
    console.log(this.t.sourceBuffers.length)
    console.log(this.C)
    this.sourceBuffer = this.t.addSourceBuffer(this.C), this.t.duration = 1 / 0, 
